...
"/survivals2.jpeg"
  ...
  
  {
    ...
    category: "projects",
    title: "Top 5 — UGRAF Nile University",
    subcategory: "awarded-outstanding-projects",
  ...
  id: "regreen",
  category: "projects",
  subcategory: "bnu-competitions",
  title: "Ultimate Innovation - Waste Management Competition",
  description: "Developed ReGreen, an innovative waste-management system that transforms discarded plastic bottles into 3D printing filament using solar energy, providing a sustainable approach to plastic recycling while producing a useful material for additive manufacturing.",
  story: "The team developed ReGreen to address the growing problem of plastic waste by giving discarded plastic bottles a practical second life. The project focuses on converting plastic bottles into usable 3D printing filament while relying on solar energy to support the process. ReGreen was recognized with the Special Award for \"Ultimate Innovation\" at the BNU Uni Waste Management Competition.",
  image: "/waste.jpeg",
  badgeText: "regreen",
  badgeClass: "badge-innovation",
  achievement: "Special Award — Ultimate Innovation",
  competition: "BNU Uni Waste Management Competition",
  organizer: "Benha National University",
  date: "2026",
  teamMembers: [
    "Hazem Yehia Mohamed",
...
},
{
  ...
  category: "projects",
  subcategory: "bnu-competitions",
  title: "Digital Presence Award — Waste Management Competition",
  description: "Developed EcoSort, an intelligent automated waste-management station that uses AI-powered computer vision to identify and automatically sort recyclable waste at the point of disposal, while transmitting real-time operational data to recycling enterprises for improved waste management and collection.",
  story: "The team developed EcoSort to make waste separation more intelligent and efficient by combining automated sorting with AI-powered vision. The system identifies recyclable materials at the point of disposal, automatically directs them into the appropriate categories, and continuously shares operational data with recycling enterprises. The project was recognized with the Digital Presence Award.",
  image: "/waste2.jpeg",
  badgeText: "ecosort",
  badgeClass: "badge-innovation",
  achievement: "Digital Presence Award",
  competition: "Waste Management Competition",
  organizer: "Benha National University",
  date: "2026",
  teamMembers: [
    "Mahmoud Abdelmonem Mahmoud Raslan",
    "Yassin Ahmed Rashed",
    "Mohamed Yasser Mohamed Mohamed",
    "Salma Ahmed El-Sorougy"
  ]
},
  {
    id: "dia-project",
...
},
{
...

  {
    ...
    achievement: "1st Place U21 & 3rd Place Men's",
    competition: "North Africa Championship",
    organizer: "Egyptian Karate Federation",
    date: "Apr 14, 2026",
    teamMembers: ["Omar Sherif Ibrahim"]
  },
  {
    id: "malak-judo",
    category: "sports-tournaments",
    ...
    image: "/malak_judo.jpeg",
    teamPhoto: "/team_malak.jpeg",
    badgeText: "Championship",
    badgeClass: "badge-sports",
    achievement: "1st Place University Championship (2x)",
    competition: "University Judo / Africa / Open Republic",
    organizer: "Al-Rifai Martyr Tournament",
    date: "Jan 28, 2026",
